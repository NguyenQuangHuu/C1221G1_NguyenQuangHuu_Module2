...
public class Villa extends  Facility{
    ...
    public Villa(String serviceName, double usableArea, double rentExpense, int maximumCapacity, String rentType, String sortOfRoom, double swimmingPoolArea, int numberOfFloors) {
